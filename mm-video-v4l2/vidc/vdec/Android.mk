...
libmm-vdec-inc          += hardware/qcom/media-caf-kraft/mm-core/inc
#DRM include - Interface which loads the DRM library
libmm-vdec-inc	        += $(OMX_VIDEO_PATH)/DivxDrmDecrypt/inc
libmm-vdec-inc          += hardware/qcom/display-caf-kraft/libgralloc
libmm-vdec-inc          += frameworks/native/include/media/openmax
libmm-vdec-inc          += frameworks/native/include/media/hardware
libmm-vdec-inc          += $(vdec-inc)
libmm-vdec-inc          += hardware/qcom/display-caf-kraft/libqdutils
libmm-vdec-inc          += hardware/qcom/media-caf-kraft/libc2dcolorconvert
libmm-vdec-inc          += hardware/qcom/display-caf-kraft/libcopybit
libmm-vdec-inc          += frameworks/av/include/media/stagefright
libmm-vdec-inc          += $(TARGET_OUT_HEADERS)/mm-video/SwVdec

ifeq ($(PLATFORM_SDK_VERSION), 18)  #JB_MR2
libOmxVdec-def += -DANDROID_JELLYBEAN_MR2=1
libmm-vdec-inc += hardware/qcom/media-caf-kraft/libstagefrighthw
endif
...
libmm-vdec-inc          += hardware/qcom/display-caf-kraft/libhwcomposer
...
mm-vdec-test-inc    := hardware/qcom/media-caf-kraft/mm-core/inc
...
mm-vdec-drv-test-inc    := hardware/qcom/media-caf-kraft/mm-core/inc
